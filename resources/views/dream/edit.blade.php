        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('dreams.update', $dream) }}">
                            @csrf
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <input id="title" type="text"
                                        ...
                                        value="{{ $dream->title }}" required autofocus>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <input id="lucidity" type="number" min="0" max="10" step="1"
                                        class="form-control @error('lucidity') is-invalid @enderror" name="lucidity"
                                        value="{{ $dream->lucidity }}" required autofocus>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <input id="rating" type="number" min="0" max="10" step="1"
                                        ...
                                        value="{{ $dream->rating }}" required autofocus>
